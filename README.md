...
Zara is written in C# (no particular 3D-engine references: [more on .Net Core example and how to use multiple instances of Zara](https://github.com/vagrod/zara/wiki/.NetCore-Demo-Notes)).\
