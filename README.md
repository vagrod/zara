...
Zara is a complete package with full implementation of inventory system with crafting. Everything, including built-inventory, will be saved and loaded on your demand, you don't have to worry about this low-level stuff, and can dedicade more time to an actual game making.
